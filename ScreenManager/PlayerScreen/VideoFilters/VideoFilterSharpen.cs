...
namespace Kinovea.ScreenManager
{
	...
	/// - Previewable 	: Yes.
	/// </summary>
	public class VideoFilterSharpen : AbstractVideoFilter
	{
		#region Properties
		...
		public VideoFilterSharpen()
		{
            ...
            m_Menu.Tag = new ItemResourceInfo(resManager, "VideoFilterSharpen_FriendlyName");
